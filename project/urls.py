...
urlpatterns = patterns('',
                       ...
                       url(r'^projects/(\d+)/reporte/backlog/$',views.reporte_backlog_producto, name='reporte_backlog_producto'),
                       url(r'^projects/(\d+)/reporte/lista_priorizada/$',views.reporte_lista_priorizada, name='reporte_lista_priorizada'),
                       url(r'^projects/(\d+)/reporte/equipo/$',views.reporte_equipo_proyecto, name='reporte_equipo_proyecto'),
